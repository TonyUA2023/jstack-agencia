        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
            ...
            <div class="space-y-10 pt-10">
                ...
                <div class="space-y-6 border-t border-white/10 pt-10">
                    ...
                    {{-- Email (ACTUALIZADO) --}}
                    <a href="mailto:admin@jstackhub.com" class="group flex items-center gap-4 transition-all hover:translate-x-2">
                        ...
                        <div>
                            ...
                            <p class="text-white text-lg font-medium">admin@jstackhub.com</p>
                        </div>
                    </a>

                    {{-- WhatsApp (ACTUALIZADO) --}}
                    <a href="https://wa.me/51989181858" target="_blank" class="group flex items-center gap-4 transition-all hover:translate-x-2">
                        ...
                        <div>
                            ...
                            <p class="text-white text-lg font-medium">+51 989 181 858</p>
                        </div>
                    </a>
                </div>
            </div>
